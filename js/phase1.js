...
const Phase1 = (function() {
  ...
  const upgrades = [
    ...
    { id: 'u_qfamiliar', name: 'Optimized Routing', desc: 'Queue drains 25% faster', cost: 200000, revealAt: 100000, revealAtQueue: 38,
      effect(s) { s.queueSpeedMult += 0.25; },
      narrative: "You've figured out the system. The queue moves faster when you know the shortcuts." },
