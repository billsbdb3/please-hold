...
const Log = (function() {
  ...
  function periodic(effectivePPS) {
    ...
    console.log('[METRICS]   Dust:' + Math.floor(s.dust) + ' | degrade:' + (degradation * 100).toFixed(1) + '% | rate:' + Dust.getRate().toFixed(1) + '/s | collectors:' + s.collectorsOwned.length + '/14 | threshold:' + Dust.getThreshold());
